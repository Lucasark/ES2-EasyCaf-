...
export default props => {
    ...
    const finalizar = () => {
        ...
        //Aceita múltipla
        setDorToraxica(false)
        setPosSCA(false)
        setPosCRVM(false);
        setAlteracaoExame(false);
        setEquivAnginoso(false);
        setLesaoCoronaria(false);
        setArritma(false);
        setSincope(false);
        setPosPTCA(false);
        setIcc(false);
        setRiscoCirúrgico(false);

        //HDA
        setDorToraxicaTipica(false);
        setAssintomatica(false);
        setDorToraxicaAtipica(false);
        setPalpitacoes(false);
        setDispneiaAoEsforco(false);
        setSincopeH(false);
        setDispneiaDeRepouso(false);
        setCansaco(false);
        ...
        setTabagismo(false);
        setObsidade(false);
        setDislipdemia(false);
        setHf(false);
        setMenopausa(false);
        setExTabagismo(false);

        //DAC Previa
        setIam(false);
        setCrvm(false);
        setPtca(false);
        setCatAlterado(false);

        //Comorbidades
        setAvc(false);
        setIrc(false);
        setAao(false);
        setDoencaVascular(false);
        ...
        switch(tela){
            ...
            case 2:
                return(
                    <div className="container">
                        <p>{msg}</p>
                        <ButtonDefault className="col-md-2" btntext="Voltar" onClick={() => setTela(1)}></ButtonDefault>
                    </div>
                )
            default:
                return(
